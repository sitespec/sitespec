...
The default v0.3 starter deliberately exercises the capabilities described above. Preserve these examples unless the user asks to simplify the project:
...
- `components/pagination` consumes `urn:site-spec:0.3:type:pagination`; page 2 is generated by the blog query rather than maintained as a separate Page Spec.
