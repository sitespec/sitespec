...
This documentation describes the current SiteSpec `specVersion: "0.3"` contract and the workflows supported by the repository today.
...
3. [Content](content.md) — define typed collections, relations, queries, pagination, and content-driven routes.
4. [CLI reference](cli.md) — run, inspect, validate, build, preview, and work with the monorepo example.
...
- update Content and CLI docs when their contracts change;
