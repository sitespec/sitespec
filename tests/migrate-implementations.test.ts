...
async function fixture() {
  ...
  await writeFile(join(componentContractsDir, "hero", "component.yaml"), `specVersion: "0.7"\ncomponent:\n  id: "hero"\n  role: "intro"\nvariants:\n  - "default"\nprops:\n  type: "object"\n  additionalProperties: false\n  required:\n    - "title"\n  properties:\n    title:\n      type: "string"\n    text:\n      type: "string"\n    primaryAction:\n      $ref: "urn:site-spec:0.7:type:action"\n`);
  await writeFile(join(componentContractsDir, "testimonials", "component.yaml"), `specVersion: "0.7"\ncomponent:\n  id: "testimonials"\n  role: "proof"\nvariants:\n  - "default"\nprops:\n  type: "object"\n  additionalProperties: false\n  properties:\n    items:\n      type: "array"\n      items:\n        type: "object"\n    media:\n      $ref: "urn:site-spec:0.7:type:image"\n    text:\n      type: "string"\n    title:\n      type: "string"\n`);
  await writeFile(join(componentContractsDir, "logo-cloud", "component.yaml"), `specVersion: "0.7"\ncomponent:\n  id: "logo-cloud"\n  role: "proof"\nvariants:\n  - "default"\nprops:\n  type: "object"\n  additionalProperties: false\n  properties:\n    items:\n      type: "array"\n      items:\n        type: "object"\n    media:\n      $ref: "urn:site-spec:0.7:type:image"\n`);
  await writeFile(join(componentContractsDir, "lead-form", "component.yaml"), `specVersion: "0.7"\ncomponent:\n  id: "lead-form"\n  role: "conversion"\nvariants:\n  - "default"\nprops:\n  type: "object"\n  additionalProperties: false\n  properties:\n    form:\n      type: "object"\n    media:\n      $ref: "urn:site-spec:0.7:type:image"\n    primaryAction:\n      $ref: "urn:site-spec:0.7:type:action"\n    text:\n      type: "string"\n    title:\n      type: "string"\n`);
  await writeFile(join(componentContractsDir, "features", "component.yaml"), `specVersion: "0.7"\ncomponent:\n  id: "features"\n  role: "content"\nvariants:\n  - "default"\nprops:\n  type: "object"\n  additionalProperties: false\n  required:\n    - "title"\n  properties:\n    media:\n      $ref: "urn:site-spec:0.7:type:image"\n    primaryAction:\n      $ref: "urn:site-spec:0.7:type:action"\n    text:\n      type: "string"\n    title:\n      type: "string"\n`);
  await writeFile(join(uiContractsDir, "button", "ui.yaml"), `specVersion: "0.7"\nui:\n  id: "button"\n  role: "action"\nvariants:\n  - "default"\n  - "ghost"\nprops:\n  type: "object"\n`);
  await writeFile(join(uiContractsDir, "link", "ui.yaml"), `specVersion: "0.7"\nui:\n  id: "link"\n  role: "navigation"\nvariants:\n  - "default"\nprops:\n  type: "object"\n`);
